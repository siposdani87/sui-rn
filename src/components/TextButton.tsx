...
export default function TextButton(props: { onPress: () => void, textColor?: string, title?: string, source?: any, iconName?: string, iconType?: string, containerStyle?: any, style?: any }) {

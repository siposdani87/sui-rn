...
import { Button, Dialog, Text, TextButton, TextField } from '../../src/components';
    ...
    <Fragment>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Dialog visible={dialog2} title='Dialog 2' buttons={[
            <TextButton key={0} title='cancel' onPress={closeDialog2} />,
            <Button key={1} title='done' onPress={closeDialog2} />,
          ]}>
          ...
          <Dialog visible={dialog3} title='Dialog 3 with long title and long long!!!' onClose={closeDialog3} buttons={[
            <TextButton key={0} title='cancel long title!!!' onPress={closeDialog3} />,
            <Button key={1} title='done with long title!!!' onPress={closeDialog3} />,
          ]}>
            <Text>Dialog 3 text</Text>
          </Dialog>
          <Button onPress={openDialog3} title='dialog3 with long titles' />
